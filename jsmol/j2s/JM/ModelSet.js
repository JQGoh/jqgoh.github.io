...
if (this.dssrData == null || this.dssrData.length < this.ac) this.dssrData =  Clazz.newIntArray (this.ac, 0);
 else for (var i = 0; i < this.ac; i++) this.dssrData[i] = 0;
...
function (i) {
return (this.dssrData == null || this.dssrData.length <= i ? 0 : this.dssrData[i]);
}, "~N");
